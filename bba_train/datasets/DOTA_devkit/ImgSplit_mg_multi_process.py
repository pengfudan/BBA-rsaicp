...
def rm_background(path):
    ...
    print(length)
    for label in label_list[:int(length * 10.0 / 10.0)]:
        filename = os.path.join(label_path, label)
        os.remove(filename)
        imagename = os.path.join(image_path, os.path.splitext(label)[0] + '.png')
        os.remove(imagename)
...
if __name__ == '__main__':
    ...
    split_path = r'/data3/plin/BBA-rsaicp/datasets/rsaicp_mg3/train/'
    split1 = splitbase(origin_path, split_path, gap=250)
    split1.splitdata(1)
    print('250 success!')
    split2 = splitbase(origin_path, split_path, gap=275)
    split2.splitdata(1)
    print('275 success!')
    split3 = splitbase(origin_path, split_path, gap=300)
    split3.splitdata(1)
    print('300 success!')
    print('1 success!')
    ...
    print('0.8 success!')
    rm_background(split_path)
    print('delete 0.8 success!')
    split.splitdata(1.2)
    print('1.2 success!')
    rm_background(split_path)
    print('delete 1.2 success!')
    '''
    #split.splitdata(0.9)
    #print('0.9 success!')
    #rm_background(split_path)
